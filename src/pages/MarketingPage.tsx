...
import { ChevronRight, Check, X, Menu, Search, TrendingUp, Users, BarChart3, Shield, FileText, Sparkles, Globe, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white relative overflow-hidden">
      ...
      <nav className="fixed top-0 w-full bg-black/40 backdrop-blur-xl border-b border-white/[0.08] z-40">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between relative">
          ...
          <div className="marketing-nav-links items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="marketing-nav-toggle p-2 rounded-lg border border-white/10 text-white hover:bg-white/10 transition-colors"
          ...
          {menuOpen && (
            <div className="absolute top-full left-0 right-0 mt-3 md:hidden bg-black/90 border border-white/10 rounded-2xl p-4 shadow-2xl backdrop-blur-xl">
              <div className="flex flex-col gap-3 text-sm">
                <a href="#features" className="text-gray-200 hover:text-white transition-colors" onClick={() => setMenuOpen(false)}>Features</a>
                <a href="#workflow" className="text-gray-200 hover:text-white transition-colors" onClick={() => setMenuOpen(false)}>Workflow</a>
                <a href="#faq" className="text-gray-200 hover:text-white transition-colors" onClick={() => setMenuOpen(false)}>FAQ</a>
                <a href="#contact" className="text-gray-200 hover:text-white transition-colors" onClick={() => setMenuOpen(false)}>Contact</a>
              </div>
            </div>
          )}
        </div>
